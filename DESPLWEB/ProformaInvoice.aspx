<%@ Page Title="Proforma Invoice" Language="C#" MasterPageFile="~/MstPg_Veena.Master" AutoEventWireup="true" CodeBehind="ProformaInvoice.aspx.cs" Inherits="DESPLWEB.ProformaInvoice" Theme="duro"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="stylized" class="myform" style="height: 470px;">
        <asp:Label ID="lblProformaInvoiceId" runat="server" Text="" Visible="false"></asp:Label>
        <asp:Label ID="lblCouponProformaInvoice" runat="server" Text="" Visible="false"></asp:Label>
                ...
                <ContentTemplate>
                    <table width="100%">
                        <tr>
                            ...
                            <td width="5%">
                                <asp:TextBox ID="txtProformaInvoiceNo" runat="server" ReadOnly="True" Width="140px">Create New.......</asp:TextBox>
                            </td>
                            <td width="9%">
                                &nbsp;
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtDate" runat="server" Width="140px" ReadOnly="true"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td valign="top" height="10px">
                                ...
                                <asp:TextBox ID="txtRecordNo" Width="90px" runat="server" ReadOnly="true"></asp:TextBox>
                            </td>
                            <td>
                    ...
                    <div>
                        <%--<tr>
                            <td colspan="6" >--%>
                        <asp:Panel ID="pnlProformaInvoiceDetail" runat="server" Height="150px" ScrollBars="Auto" Width="99%"
                                    ...
                                    <asp:GridView ID="grdDetails" runat="server" AutoGenerateColumns="false" SkinID="gridviewSkin"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="SAC Code" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtSACCode" runat="server" Style="text-align: Center;" Width="100px" BorderWidth="0px" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
    ...
    <script type="text/javascript">
        ...
        function validate1() {
            ...
            var GVMaintainProformaInvoiceMaster = document.getElementById("<%= grdDetails.ClientID %>");
            for (var rowId = 1; rowId < GVMaintainProformaInvoiceMaster.rows.length; rowId++) {
                var txttdescp = GVMaintainProformaInvoiceMaster.rows[rowId].cells[3].getElementsByTagName("input")[0];
                var txttquantity = GVMaintainProformaInvoiceMaster.rows[rowId].cells[4].children[0];
                var txttcost = GVMaintainProformaInvoiceMaster.rows[rowId].cells[5].children[0];
                var txttCoupFrom = GVMaintainProformaInvoiceMaster.rows[rowId].cells[3].getElementsByTagName("input")[0];
                //var txttCoupTo = GVMaintainProformaInvoiceMaster.rows[rowId].cells[3].getElementsByTagName("input")[1];
            ...
            if (document.getElementById("<%=txtNet.ClientID%>").value == "0.00") {
                alert('Your Net aomunt is 0.00 ' + '\n' + 'ProformaInvoicel can not be genearted');
                return false;
            }
