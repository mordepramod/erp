<%@ Page Title="Steel Report" Language="C#" MasterPageFile="~/MstPg_Veena.Master" AutoEventWireup="true" CodeBehind="Steel_ReportNew.aspx.cs" Inherits="DESPLWEB.Steel_ReportNew" Theme="duro" %>
        ...
        <asp:Panel ID="pnlContent" runat="server" Width="100%" BorderWidth="0px"  Height="470px"
            ...
            <asp:Panel ID="Panel3" runat="server" BorderStyle="Ridge" Width="942px" BorderColor="AliceBlue">
                <table style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txt_Supplier" Width="190px" runat="server"></asp:TextBox>
                        </td>
                        <td style="text-align: right">
            ...
            <asp:Panel ID="Mainpan" runat="server" ScrollBars="Auto" Height="100px" BorderStyle="Ridge"
                ...
                <%--<asp:UpdatePanel ID="UpdatePanel3" runat="server">
                    <ContentTemplate>--%>
                        <asp:GridView ID="grdSteelEntry" runat="server" SkinID="gridviewSkin" OnRowCommand="grdSteelEntry_RowCommand">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Images" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        ...
                                        CommandName="ViewImages">view</asp:LinkButton>
