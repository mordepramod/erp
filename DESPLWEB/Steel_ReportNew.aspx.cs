...
namespace DESPLWEB
{
    public partial class Steel_ReportNew : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                //    PrintPDFReport.cnStr.ToLower().Contains("nashik") == true)
                //{
        ...
        public void DisplayDetailSteelGrid()
        {
            ...
            foreach (var st in details)
            {
                ...
                {
                    if (st.STDETAIL_Bend_var == "Satisfied")
                        ddl_Bend.SelectedValue = "Satisfactory";
                    else if (st.STDETAIL_Bend_var == "Not Satisfied")
                        ddl_Bend.SelectedValue = "Unsatisfactory";
                    else
                        ddl_Bend.SelectedValue = st.STDETAIL_Bend_var.ToString();                    
                }
                if (st.STDETAIL_Rebend_var != null && st.STDETAIL_Rebend_var.ToString() != "")
                {
                    if (st.STDETAIL_Rebend_var == "Satisfied")
                        ddl_Rebend.SelectedValue = "Satisfactory";
                    else if (st.STDETAIL_Rebend_var == "Not Satisfied")
                        ddl_Rebend.SelectedValue = "Unsatisfactory";
                    else
                        ddl_Rebend.SelectedValue = st.STDETAIL_Rebend_var.ToString();
                }
        ...
        protected void lnkSave_Click(object sender, EventArgs e)
        {
            if (ValidateData() == true)
            {
                ...
                {
                    dc.AllInwd_Update(txt_ReferenceNo.Text, txt_witnessBy.Text, 0, DateofTesting, txt_Description.Text,  txt_Supplier.Text, 2, 0, "", 0, ddl_ComplainceNote.SelectedItem.Text, "", 0, 0, 0, "ST");
                ...
                {
                    dc.AllInwd_Update(txt_ReferenceNo.Text, txt_witnessBy.Text, 0, DateofTesting, txt_Description.Text, txt_Supplier.Text, 3, 0, "", 0, ddl_ComplainceNote.SelectedItem.Text, "", 0, 0, 0, "ST");
        ...
        protected void grdSteelEntry_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "ViewImages")
            {
                GridViewRow grdrow = (GridViewRow)(((LinkButton)e.CommandSource).NamingContainer);
                int rowindex = grdrow.RowIndex;
                Label lblWtMeterImage1 = (Label)grdSteelEntry.Rows[rowindex].FindControl("lblWtMeterImage1");
                Label lblTensileImage1 = (Label)grdSteelEntry.Rows[rowindex].FindControl("lblTensileImage1");
                Label lblTensileImage2 = (Label)grdSteelEntry.Rows[rowindex].FindControl("lblTensileImage2");
                Label lblTensileImage3 = (Label)grdSteelEntry.Rows[rowindex].FindControl("lblTensileImage3");
                Label lblBendImage1 = (Label)grdSteelEntry.Rows[rowindex].FindControl("lblBendImage1");
                Label lblRebendImage1 = (Label)grdSteelEntry.Rows[rowindex].FindControl("lblRebendImage1");
                if (lblWtMeterImage1.Text != "" || lblTensileImage1.Text != "" || lblTensileImage2.Text != ""
                || lblTensileImage3.Text != "" || lblBendImage1.Text != "" || lblRebendImage1.Text != "")
                {
                    string strImages = getSteelImagesString(txt_ReferenceNo.Text, rowindex);
        ...
        protected string getSteelImagesString(string referenceNo, int serialNo)
        {
            LabDataDataContext dc = new LabDataDataContext();
            ...
            int srNo = 0;
            Label lblWtMeterImage1 = (Label)grdSteelEntry.Rows[serialNo].FindControl("lblWtMeterImage1");
            Label lblTensileImage1 = (Label)grdSteelEntry.Rows[serialNo].FindControl("lblTensileImage1");
            Label lblTensileImage2 = (Label)grdSteelEntry.Rows[serialNo].FindControl("lblTensileImage2");
            Label lblTensileImage3 = (Label)grdSteelEntry.Rows[serialNo].FindControl("lblTensileImage3");
            Label lblBendImage1 = (Label)grdSteelEntry.Rows[serialNo].FindControl("lblBendImage1");
            Label lblRebendImage1 = (Label)grdSteelEntry.Rows[serialNo].FindControl("lblRebendImage1");
            if (lblWtMeterImage1.Text != "" || lblTensileImage1.Text != "" || lblTensileImage2.Text != "" 
                || lblTensileImage3.Text != "" || lblBendImage1.Text != "" || lblRebendImage1.Text != "" )
            {

                
                if (lblWtMeterImage1.Text != "" &&
                    NewWindows.CheckFileExist(imgLink + lblWtMeterImage1.Text) == true)
                {
                    srNo++;
                    myStr += "<tr>";
                    myStr += "<td width= 10% align=left valign=top height=19 ><font size=2>&nbsp;" + "Weight Per Meter" + "</font></td>";
                    myStr += "<td width= 40% >";
                    myStr += "<img border=0 Width=500 height=200 src='" + imgLink + lblWtMeterImage1.Text + "' >";                    
                    myStr += "</td>";
                    myStr += "</tr>";
                }
                myStr += "<tr><td width= 5% align=left valign=top height=19 colspan=2><font size=2>&nbsp;</font></td></tr>";

                if (lblTensileImage1.Text != "" &&
                    NewWindows.CheckFileExist(imgLink + lblTensileImage1.Text) == true)
                {
                    srNo++;
                    myStr += "<tr>";
                    myStr += "<td width= 10% align=left valign=top height=19 ><font size=2>&nbsp;" + "Tensile - Elongation 1" + "</font></td>";
                    myStr += "<td width= 40% >";
                    myStr += "<img border=0 Width=500 height=200 src='" + imgLink + lblTensileImage1.Text + "' >";
                    myStr += "</td>";
                    myStr += "</tr>";
                }
                myStr += "<tr><td width= 5% align=left valign=top height=19 colspan=2><font size=2>&nbsp;</font></td></tr>";

                if (lblTensileImage2.Text != "" &&
                    NewWindows.CheckFileExist(imgLink + lblTensileImage2.Text) == true)
                {
                    srNo++;
                    myStr += "<tr>";
                    myStr += "<td width= 10% align=left valign=top height=19 ><font size=2>&nbsp;" + "Tensile - Elongation 2" + "</font></td>";
                    myStr += "<td width= 40% >";
                    myStr += "<img border=0 Width=500 height=200 src='" + imgLink + lblTensileImage2.Text + "' >";
                    myStr += "</td>";
                    myStr += "</tr>";
                }
                myStr += "<tr><td width= 5% align=left valign=top height=19 colspan=2><font size=2>&nbsp;</font></td></tr>";

                if (lblTensileImage3.Text != "" &&
                    NewWindows.CheckFileExist(imgLink + lblTensileImage3.Text) == true)
                {
                    srNo++;
                    myStr += "<tr>";
                    myStr += "<td width= 10% align=left valign=top height=19 ><font size=2>&nbsp;" + "Tensile - Elongation 3" + "</font></td>";
                    myStr += "<td width= 40% >";
                    myStr += "<img border=0 Width=500 height=200 src='" + imgLink + lblTensileImage3.Text + "' >";
                    myStr += "</td>";
                    myStr += "</tr>";
                }
                myStr += "<tr><td width= 5% align=left valign=top height=19 colspan=2><font size=2>&nbsp;</font></td></tr>";

                if (lblBendImage1.Text != "" &&
                    NewWindows.CheckFileExist(imgLink + lblBendImage1.Text) == true)
                {
                    srNo++;
                    myStr += "<tr>";
                    myStr += "<td width= 10% align=left valign=top height=19 ><font size=2>&nbsp;" + "Bend" + "</font></td>";
                    myStr += "<td width= 40% >";
                    myStr += "<img border=0 Width=500 height=200 src='" + imgLink + lblBendImage1.Text + "' >";
                    myStr += "</td>";
                    myStr += "</tr>";
                }
                myStr += "<tr><td width= 5% align=left valign=top height=19 colspan=2><font size=2>&nbsp;</font></td></tr>";

                if (lblRebendImage1.Text != "" &&
                    NewWindows.CheckFileExist(imgLink + lblRebendImage1.Text) == true)
                {
                    srNo++;
                    myStr += "<tr>";
                    myStr += "<td width= 10% align=left valign=top height=19 ><font size=2>&nbsp;" + "Rebend" + "</font></td>";
                    myStr += "<td width= 40% >";
                    myStr += "<img border=0 Width=500 height=200 src='" + imgLink + lblRebendImage1.Text + "' >";
                    myStr += "</td>";
                    myStr += "</tr>";
                }
                myStr += "<tr><td width= 5% align=left valign=top height=19 colspan=2><font size=2>&nbsp;</font></td></tr>";
