<%@ Page Title="Enquiry-Proposal" Language="C#" MasterPageFile="~/MstPg_Veena.Master"
    AutoEventWireup="true" CodeBehind="EnquiryProposal.aspx.cs" Inherits="DESPLWEB.EnquiryProposal"
            ...
            <table style="width: 100%">
                ...
                <tr>
                    ...
                    <td colspan="3" align="right">
                        ...
                        <div id="divHolder">
                                Put your content here for your bulk update
                        </div>
                ...
                <tr valign="top">
                    ...
                    <td style="width: 55%" colspan="3">
                        ...
                        <asp:CheckBox ID="chkNewClient" Text="New" runat="server" AutoPostBack="true" OnCheckedChanged="chkNewClient_CheckedChanged" />&nbsp;
                ...
                <tr valign="top">
                    ...
                    <td>
                        ...
                        &nbsp;&nbsp;&nbsp;<asp:Label ID="lblSTCoupons" runat="server" Text=""></asp:Label> <br /> &nbsp;
                    </td>
                </tr>
                <tr valign="top">
                    <td align="right">
                ...
                <tr valign="top">
                    ...
                    <td>
                        <asp:DropDownList ID="ddl_EnqType" Width="215px" runat="server">
                            ...
                            <asp:ListItem Value="Generated By ME">Generated By ME</asp:ListItem>
                        </asp:DropDownList>
                        <br />
                        &nbsp;
                    </td>
                        ...
                        <tr valign="top">
                            ...
                            <td colspan="4">
                                ...
                                <asp:LinkButton ID="lnkAddNewRowToGrid" OnClick="lnkAddNewRowToGrid_Click" Font-Underline="true"
                                    runat="server" Visible="true">Add New Row</asp:LinkButton>
