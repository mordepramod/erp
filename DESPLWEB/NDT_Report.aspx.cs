...
namespace DESPLWEB
{
    public partial class NDT_Report : System.Web.UI.Page
    {
        ...
        private void LoadReferenceBillList(int clientId, int siteId)
        {
            //var billList = dc.Bill_View_ClientSiteWiseList(clientId, siteId,"MF");
            //ddlReferenceBill.DataTextField = "Bill_Id";
            //ddlReferenceBill.DataSource = billList;
            //ddlReferenceBill.DataBind();
            //ddlReferenceBill.Items.Insert(0, new ListItem("---Select---", "0"));
        }
        ...
        public void DisplayNDT_Details()
        {
            try
            {
                ...
                foreach (var cr in InwardNDT)
                {
                    ...
                    //else if (Convert.ToBoolean(cr.NDTINWD_UPVIndirect_bit) == true)
                    //{
                    ...
                    //if (cr.INWD_BILL_Id == null || cr.INWD_BILL_Id == "0")
                    //{
                    //    lblReferenceBill.Visible = true;
                    //    ddlReferenceBill.Visible = true;
                    //    LoadReferenceBillList(Convert.ToInt32(cr.INWD_CL_Id), Convert.ToInt32(cr.INWD_SITE_Id));
                    //}
                    //else
                    //{
                    //    lblReferenceBill.Visible = false;
                    //    ddlReferenceBill.Visible = false;
                    //    ddlReferenceBill.DataSource = null;
                    //    ddlReferenceBill.DataBind();
                    //}
                }                
            }
        ...
        public void Calculation()
        {
            ...
            for (int i = 0; i < grdNDTInward.Rows.Count; i++)
            {
                ...
                if (lblMergFlag.Text != "1")
                {
                    ...
                    if (txt_CastingDt.Text.ToUpper() != "NA")
                    {
        ...
        //        TextBox txt_Description = (TextBox)grdNDTInward.Rows[Convert.ToInt32(rowindex)].Cells[4].FindControl("txt_Description");
        //        //if (
        //        //   grdNDTInward.Rows[rowindex].Cells[5].Visible == false &&
        //        //   grdNDTInward.Rows[rowindex].Cells[6].Visible == false &&
        //        //   grdNDTInward.Rows[rowindex].Cells[7].Visible == false &&
        //        //   grdNDTInward.Rows[rowindex].Cells[8].Visible == false &&
        //        //   grdNDTInward.Rows[rowindex].Cells[9].Visible == false &&
        //        //   grdNDTInward.Rows[rowindex].Cells[10].Visible == false &&
        //        //   grdNDTInward.Rows[rowindex].Cells[11].Visible == false
        //        //    )
        //        if (lblMergFlag.Text == "1")
        //        {
        //            //DeleteRowReportCoreInward(rowindex);
        //            //AddRowEnterReportNDTInward();
        //            lblMergFlag.Text = "0";
        //            grdNDTInward.Rows[Convert.ToInt32(rowindex)].Cells[4].ColumnSpan = 1;
        //            txt_Description.Width = 760;
        //            //txt_Description.Width = grdNDTInward.Width;
        //            //txt_Description.CssClass = "Titlecol";
        //            //grdNDTInward.Rows[i].Cells[3].CssClass = "Srcol";
        //            //grdNDTInward.Rows[i].Cells[4].CssClass = "hiddencol";
        //            grdNDTInward.Rows[Convert.ToInt32(rowindex)].Cells[5].Visible = true;
        //            grdNDTInward.Rows[Convert.ToInt32(rowindex)].Cells[6].Visible = true;
        //            grdNDTInward.Rows[Convert.ToInt32(rowindex)].Cells[7].Visible = true;
        //            grdNDTInward.Rows[Convert.ToInt32(rowindex)].Cells[8].Visible = true;
        ...
        public void RptNDT_Testing()
        {
            ...
            //reportStr = getDetailReportNDTTesting();
        ...
        //protected string getDetailReportNDTTesting()
        //{
        ...
        //    var NDT_Test = dc.ReportStatus_View("Non Destructive Testing", null, null, 0, 0, 0, txt_ReferenceNo.Text, 0, 2, 0);
        ...
        //    }
        //    int SrNo = 0;
        //    var NDT_Testing = dc.TestDetail_Title_View(txt_ReferenceNo.Text, 0, "NDT", false);
        ...
        //                {
        //                    var crr = dc.TestDetail_Title_View(txt_ReferenceNo.Text, Convert.ToInt32(Ndt.TitleId_int), "NDT", false);
        //                    foreach (var title in crr)
        //                    {
        //                        mySql += "<tr>";
        ...
        //    if (lblEntry.Text == "Check")
        //    {
        //        var RecNo = dc.ReportStatus_View("Non Destructive Testing", null, null, 1, 0, 0, Convert.ToString(txt_ReferenceNo.Text), 0, 0, 0);
