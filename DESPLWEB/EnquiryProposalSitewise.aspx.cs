...
namespace DESPLWEB
{
    public partial class EnquiryProposalSitewise : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                lblheading.Text = "Add Enquiry & Proposal - SiteWise";
                ...
                else if (lblEnqType.Text == "VerifyClient")
                {
                    ...
                    foreach (var Enqry in viewEnquiry)
                    {
                        ...
                        if (Convert.ToString(Enqry.ENQNEW_Type_var) != "" && Convert.ToString(Enqry.ENQNEW_Type_var) != null)
                            ddl_EnqStatus.SelectedItem.Text = Convert.ToString(Enqry.ENQNEW_Type_var);
                        else
                        ...
                        if (Convert.ToString(Enqry.ENQNEW_GeneratedStatus_var) != "" && Convert.ToString(Enqry.ENQNEW_GeneratedStatus_var) != null)
                            ddl_EnqType.SelectedItem.Text = Convert.ToString(Enqry.ENQNEW_GeneratedStatus_var);
                        else
        ...
        public void CRLimitExceedEmail(string enquiryId, string inwardType)
        {
            ...
            //var enquiry = dc.Enquiry_View_MailId(Convert.ToInt32(enquiryId));
            //var enquiry = dc.MailIdForCRLExceed_View(Convert.ToInt32(enquiryId), 0, 0, "", "Enquiry");
            ...
            if (mailIdTo != "")
            {
                ...
                if (strEnqAmount == "0")
                    mbody = mbody + "We thank you for your enquiry (no. " + strEnqNo + ") on date " + strEnqDate + "<br><br><br><br>";
                else
                   mbody = mbody + "We thank you for your enquiry (no. " + strEnqNo + ") on date " + strEnqDate + ". We can arrange material pickup once we recieve the order confirmation.<br><br><br><br>";


                //if (Convert.ToDecimal(strOutstndingAmt) <= 0)//new customer
                //    mbody = mbody + "We have received your enquiry no. " + strEnqNo + " on date " + strEnqDate + ", total cost of testing is Rs. " + strEnqAmount + ", please arrange to make the payment in advance. If you have already made the payment, please ignore this message.<br><br><br>";
                //else //existing cutstomer
                //    mbody = mbody + "We have received your enquiry no. " + strEnqNo + " on date " + strEnqDate + ", total cost of testing is Rs. " + strEnqAmount + ",however your total outstanding is Rs " + strOutstndingAmt + ".<br>Please arrange to make the payment in advance. If you have already made the payment, please ignore this message.<br><br><br>";
        ...
        protected void txt_Client_TextChanged(object sender, EventArgs e)
        {
            ...
            if (ChkClientName(txt_Site.Text) == true)
            {
                ...
                foreach (var st in site)
                {
                    ...
                    txtEmail.Text = Convert.ToString(st.SITE_EmailID_var);
        ...
        protected void txt_Site_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                int SiteId = 0; string status = "Regular";
        ...
        protected void ddl_InwardType_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                ddlOtherTest.Visible = true; LoadOtherTestList();
            }
            else
            {
                ...
                //if (ddl_InwardType.SelectedValue == "NDT" && ddl_InwardType.SelectedValue == "CR" && ddl_InwardType.SelectedValue == "CORECUT")
                //{
        ...
        public double getDiscount(string recordType)
        {
            ...
            //{
            //    //for ST  if applied dis<30 then set it to bydefault 30 01-02-2019
            //    if (recordType == "ST")
            //    {
            //        if (appliedDisc < 30)
            //            appliedDisc = 30;
        ...
        public void SendMailAfterEnquiryRegistered(string enquiryId, string inwardType, string mailIdTo, string mailIdCc,DateTime enqDate)
        {
            ...
            if (sendMail == true)
            {
                ...
                mbody = "Dear Customer,<br><br>";
                //mbody = mbody + "We have received your enquiry for " + inwardType + " Enquiry No. " + enquiryId + ".";
        ...
        protected void btn_PrintProposal_Click(object sender, EventArgs e)
        {
            if (lblEnqId.Text != "")
            {
                ...
                var res = dc.Proposal_View(Convert.ToInt32(lblEnqId.Text), false, 0, txt_ProposalNo.Text);
                ...
                rpt.Proposal_PDF(Convert.ToInt32(lblEnqId.Text), qtyFlag, proposalId, false, "View", txt_ProposalNo.Text);
            }
        }
        ...
        protected void btn_SaveEnquiryProposal_Click(object sender, EventArgs e)
        {
            ...
            if (flagEnqProposal)
            {
                ...
                string strEnqId = "", mailIdCC = "", mailIdTo = "";
                ...
                if (valid == true && ValidateEnqStatus() == true)
                {
                    ...
                    try
                    {
                        ...
                        if (clientId == 0)
                        {
                            ...
                            EnQ_No = dc.EnquiryNewClient_Update(EnqId, ENQ_Date_dt, ENQ_Status_tint, materialId, Convert.ToInt32(Session["LoginId"]), txt_Note.Text, txt_Reference.Text, OpenEnQuiryStatus, comment, MaterialSendingOnDate, TestingDate, ENQ_LOCATION_Id, ENQ_ROUTE_Id, CollectionDate, ENQ_UrgentStatus_bit, ClentExpectedDate, null, ENQ_CollectedAt_var, "", ENQ_DriverId, qty, Convert.ToInt32(Session["LoginId"]), txt_Client.Text.Trim(), txt_Site.Text.Trim(), txt_Site_address.Text.Trim(), txt_Site_LandMark.Text.Trim(), txt_ContactPerson.Text.Trim(), txt_Contact_No.Text.Trim(), enquiryStatus, enqType, Convert.ToBoolean(ENQ_ConfirmStatus_bit), Convert.ToBoolean(ENQ_WalkingStatus_bit), Convert.ToInt32(ENQ_OrderStatus_bit),Convert.ToString(txt_EnqEmail.Text), "");
                        ...
                        else
                        {
                            ...
                            byte enqStatus = 0;
                            ApproveDate = DateTime.Now; //int redTagCL = 0;
                        ...
                        if (flagProposal)
                        {
                            ...
                            if (grdClientScope.Visible == true)
                            {
                                for (int i = 0; i < grdClientScope.Rows.Count; i++)
                                {
                                    TextBox txt_NOTEClientScope = (TextBox)grdClientScope.Rows[i].Cells[2].FindControl("txt_NOTEClientScope");
                            ...
                            if (txtEmail.Text != "") //update email of existing client
                            {
                            ...
                            if (chkPropSendForAppr.Checked == false)
                            {
                                ...
                                PrintPDFReport rpt = new PrintPDFReport();
                                rpt.Proposal_PDF(Convert.ToInt32(strEnqId), 0, proposalId, false, "Email", txt_ProposalNo.Text);
        ...
        private void addEnquiryDetails()
        {
            ...
            else if (rbOrderLoss.Checked)
            {
               // ddl_MatCollectn.Items.Insert(1, new ListItem("Decision Pending", "1"));
                ddl_MatCollectn.Items.Insert(2, new ListItem("Declined by us", "2"));
                ddl_MatCollectn.Items.Insert(3, new ListItem("Declined by Client", "3"));
            }
            else if (rbDecisionPending.Checked)
            {
                ddl_MatCollectn.Items.Insert(1, new ListItem("Decision Pending", "1"));
