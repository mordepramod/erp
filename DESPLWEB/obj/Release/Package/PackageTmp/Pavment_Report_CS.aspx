<%@ Page Title="Pavement Compressive Strength " Language="C#" MasterPageFile="~/MstPg_Veena.Master"
    AutoEventWireup="true" CodeBehind="Pavment_Report_CS.aspx.cs" Inherits="DESPLWEB.Pavement_Report_CS"
    Theme="duro" %>
    ...
    <div id="stylized" class="myform" style="height: 470px;">
        <asp:Panel ID="pnlContent" runat="server" Width="100%" BorderWidth="0px" Height="470px"
            ...
            <asp:Panel ID="Mainpan" runat="server" ScrollBars="Auto" Height="150px" Width="942px"
                ...
                <asp:UpdatePanel runat="server" ID="UpdatePanel1">
                    <ContentTemplate>
                        <asp:GridView ID="grdPT_CSInward" runat="server" SkinID="gridviewSkin" Width="100%"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Plan Area" HeaderStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        <asp:Button ID="Btn_PlanArea" BackColor="White" OnCommand="Btn_PlanArea_Click" BorderWidth="0px"
                                            Width="100px" ForeColor="Black" runat="server" />
                                        <%--    <asp:TextBox ID="txt_PlanArea" BorderWidth="0px" CssClass="textbox" MaxLength="10"
                                            runat="server" Text='' Width="80px" onchange="checkNumber(this);" />--%>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Weight" HeaderStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txt_Weight" BorderWidth="0px" CssClass="textbox" runat="server"
                                            Text='' Width="80px" MaxLength="10" onchange="CheckWeight(this);" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Reading" HeaderStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txt_Reading" BorderWidth="0px" CssClass="textbox" MaxLength="10"
                                            runat="server" Text='' Width="80px" onchange="checkReading(this);" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="" HeaderStyle-HorizontalAlign="Center" Visible="false">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txt_ActualresultDtls1" Visible="false" ReadOnly="true" runat="server" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
                    ...
                    <ContentTemplate>
                        <div>
                            <table class="DetailPopup" width="200px">
                                <tr>
                                    <td>
                                        <asp:Label ID="lbl_Msg" Text="" runat="server" Font-Bold="true" ForeColor="Red"></asp:Label>
                                    </td>
                                    <td align="right" valign="top">
                                        <asp:ImageButton ID="ImgExit" runat="server" ImageUrl="Images/cross_icon.png"
                                            ImageAlign="Right" OnClick="ImgExit_Click" />
                                        <%--OnClientClick="HideModalPopup()"--%>
                                        <%--  &nbsp; &nbsp;
                                ...
                                <tr>
                                    <td colspan="2">
                                        <asp:Panel ID="Panel5" runat="server" Height="150px" Width="200px">
                                                ...
                                                <fieldset style="border-color: #008080; width: 88%; height: 130px;">
                                                    ...
                                                    <table width="100%">
                                                        <tr>
                                                            ...
                                                            <td>&nbsp;&nbsp;
                                                                <asp:TextBox ID="txt_T1" Width="120px" Style="text-align: right"
                                                                    runat="server" MaxLength="3" onchange="checkPopupNumber(this);"></asp:TextBox>
                                                                <%--onkeyup="checkPopupNumber(this);"--%>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                            ...
                                                            <td>&nbsp;&nbsp;
                                                                <asp:TextBox ID="txt_T2" Width="120px" Style="text-align: right" runat="server" MaxLength="3"
                                                                    onchange="checkPopupNumber(this);"></asp:TextBox>
                                                                <%--onchange="checkPopupNumber(this);"--%>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                            ...
                                                            <td>&nbsp;&nbsp;
                                                                <asp:TextBox ID="txt_T3" Width="120px" Style="text-align: right" runat="server" MaxLength="3"
                                                                    onchange="checkPopupNumber(this);"></asp:TextBox>
                                                                <%--onchange="checkPopupNumber(this);"--%>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>&nbsp;&nbsp;
                                                                <asp:TextBox ID="txt_T4" Width="120px" Style="text-align: right" runat="server" MaxLength="3"
                                                                    onchange="checkPopupNumber(this);"></asp:TextBox>
                                                                <%--onchange="checkPopupNumber(this);"--%>
                                                            </td>
                                                        </tr>
            ...
            <asp:ModalPopupExtender ID="ModalPopupExtender2" runat="server" BehaviorID="ModalPopupBehaviorID1"
                TargetControlID="HiddenField2" PopupControlID="Panel3" PopupDragHandleControlID="PopupHeader"
                Drag="true" BackgroundCssClass="ModalPopupBG">
            </asp:ModalPopupExtender>
                    ...
                    <ContentTemplate>
                        <div>
                            <table class="DetailPopup" width="200px">
                                <tr>
                                    <td>
                                        <asp:Label ID="lbl_Msg1" Text="" runat="server" Font-Bold="true" ForeColor="Red"></asp:Label>
                                    </td>
                                    <td align="right" valign="top">
                                        <asp:ImageButton ID="Img_Exit" runat="server" ImageUrl="Images/cross_icon.png"
                                            ImageAlign="Right" OnClick="Img_Exit_Click" />
                                        <%--OnClientClick="HideModalPopup1()"--%>
                                        <%--&nbsp; &nbsp;
                                        <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="Images/T.jpeg"
                                            ImageAlign="Right" Width="18px" Height="18px" OnClick="imgCloseTestDetails_Click" />--%>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                                        <asp:CheckBox ID="chkGraph" Checked="true" runat="server" AutoPostBack="true" OnCheckedChanged="chkGraph_CheckChanged"
                                            Text="By Graph" />
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                                        <asp:Panel ID="Panel6" runat="server" Height="110px" Width="200px">
                                            <div id="div1" runat="server">
                                                <fieldset style="border-color: #008080; width: 88%; height: 100px;">
                                                    <legend>Plan Area</legend>
                                                    <table width="100%">
                                                        <tr>
                                                            <td style="width: 50%">
                                                                <asp:Label Width="80px" ID="lbl_Dwt" runat="server" Text="PlanArea"></asp:Label>
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="txt_Dwt" Width="80px" Style="text-align: right"
                                                                    runat="server" MaxLength="6" onchange="checkPopupNumber(this);"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <asp:Label ID="lbl_Wwt" runat="server" Text="Weight In Water" Visible="false"></asp:Label>
                                                            </td>
                                                            <td>
                                                                <asp:TextBox ID="txt_Wwt" Width="80px" Style="text-align: right" Visible="false"
                                                                    runat="server" MaxLength="6" onchange="checkPopupNumber(this);"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                    </table>
                                ...
                                <tr>
                                    <td colspan="2" align="right" valign="bottom">
                                        <br />
                                        <asp:ImageButton ID="imgClosePlanArea" runat="server" ImageUrl="Images/T.jpeg" ImageAlign="Right"
                                            Width="18px" Height="18px" OnClick="imgClosePlanArea_Click" />
                                    </td>
                                </tr>
                            </table>
                        </div>
        ...
        <script type="text/javascript">
            ...
            function HideModalPopup1() {
                $find("ModalPopupBehaviorID1").hide();
            }
