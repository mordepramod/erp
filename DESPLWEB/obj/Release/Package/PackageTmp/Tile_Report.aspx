    ...
    <div id="stylized" class="myform" style="height: 470px;">
        <asp:Panel ID="pnlContent" runat="server" Width="100%" BorderWidth="0px" Height="470px"
            ...
            <asp:Panel ID="pnlTileTab" runat="server" Height="340px" Width="942px" BorderColor="DimGray"
                ...
                <cc1:TabContainer ID="TabContainerTile" runat="server" Width="942px" ActiveTabIndex="2"
                    Height="280px">
...
<asp:TemplateField HeaderText="Dry Weight"><ItemTemplate>
...
<asp:TemplateField HeaderText="Wet Weight"><ItemTemplate>
...
<asp:TemplateField HeaderText="Water Absorption"><ItemTemplate>
...
<asp:TemplateField HeaderText="Avg. Water Absorption(%)"><ItemTemplate>
