<%@ Page Language="C#" AutoEventWireup="true" Title="Cube Test Report" MasterPageFile="~/MstPg_Veena.Master"
    CodeBehind="Cube_Report.aspx.cs" Inherits="DESPLWEB.Cube_Report" Theme="duro" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="stylized" class="myform" style="height: 470px;">
        <asp:Panel ID="pnlContent" runat="server" Width="100%" BorderWidth="0px" Height="470px"
            ...
            <asp:Panel ID="Panel2" runat="server" BorderStyle="Ridge" Width="942px" BorderColor="AliceBlue" Height="130px" ScrollBars="Auto">
                <table style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txt_DtOfCasting" Width="200px" runat="server" onblur="CalculateCastingDt(this)"></asp:TextBox>
                        </td>
                        <td>
            ...
            <asp:Panel ID="Mainpan" runat="server" ScrollBars="Auto" Height="125px" Width="942px"
                ...
                <asp:GridView ID="grdCubeInward" runat="server" SkinID="gridviewSkin" OnRowCommand="grdCubeInward_RowCommand">
                    <Columns>
