<%@ Page Language="C#" MasterPageFile="~/MstPg_Veena.Master" AutoEventWireup="true"
    CodeBehind="Flyash_Inward.aspx.cs" Inherits="DESPLWEB.FlyAsh_Inward"
    Title="Fly Ash Inward" Theme="duro" %>
            ...
            <tr>
                <td colspan="4">
                    <asp:Panel ID="pnlControl" runat="server" ScrollBars="Auto" Width="90%">
                        <uc1:UC_InwardHeader ID="UC_InwardHeader1" runat="server" OnTextChanged="TextChanged"  OnClick="Click"/>
                    </asp:Panel>
                </td>
            </tr>
            <tr style="background-color: #ECF5FF;">
                ...
                <td colspan="4" style="height: 23px" valign="top">
                    <asp:Panel ID="Mainpan" runat="server" ScrollBars="Auto" Height="180px" Width="940px">
                        <asp:UpdatePanel runat="server" ID="UpdatePanel1">
                            <ContentTemplate>
                                <asp:GridView ID="grdFlyAshInward" runat="server" SkinID="gridviewSkin" AutoGenerateColumns="false" OnRowDataBound="grdFlyAshInward_RowDataBound">
                                    <Columns>
                                        <asp:BoundField DataField="lblSrNo" HeaderText="Sr.No" HeaderStyle-HorizontalAlign="Center"
                                            ItemStyle-HorizontalAlign="Center"></asp:BoundField>
                                        <asp:TemplateField HeaderText="Fly Ash Name"  HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtFlyAshName" runat="server" BorderWidth="0px" Width="110px" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Cement Name" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtCementName" runat="server" Text='' BorderWidth="0px" Width="110px" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Quantity" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtQty" runat="server" MaxLength="2" BorderWidth="0px" Width="50px" style="text-align: right"
                                                    onchange="checkNum(this)"></asp:TextBox>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Description" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtDescription" runat="server" BorderWidth="0px" Width="110px"></asp:TextBox>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Supplier Name" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <%--<asp:TextBox ID="txtSupplierName" runat="server" BorderWidth="0px" Width="110px"></asp:TextBox>--%>
                                                <asp:DropDownList ID="ddlSupplier" runat="server" BorderWidth="0px" Width="110px" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Test Details" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtTestDetails" runat="server" ReadOnly="true" BorderWidth="0px"
                                                    Width="300px" />
                                                <asp:LinkButton ID="lnkRateList" runat="server" CommandName="Select" OnCommand="lnkRateList_Click" Font-Underline="true" >  Select Test</asp:LinkButton>
                                            </ItemTemplate>                                            
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
                                    ...
                                    <asp:UpdatePanel runat="server" ID="UpdatePanel2">
                                        <ContentTemplate>
                                            <asp:GridView ID="grdTestDetails" runat="server" AutoGenerateColumns="False" BackColor="#CCCCCC"
                                                ...
                                                Width="100%" CellPadding="4" CellSpacing="0" OnRowCommand="grdTestDetails_RowCommand">
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="" HeaderStyle-HorizontalAlign="Left" ItemStyle-Width="200px">
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:LinkButton ID="lnkAddrow" runat="server" CommandName="Add"> </asp:LinkButton>
                                                            &nbsp; &nbsp;
                                                            <asp:LinkButton ID="lnkDeleterow" runat="server" CommandName="Delete" OnCommand="lnkDeleterow_Click"> </asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
