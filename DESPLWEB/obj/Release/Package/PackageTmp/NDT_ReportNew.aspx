<%@ Page Title="NDT Report Entry" Language="C#" MasterPageFile="~/MstPg_Veena.Master" AutoEventWireup="true" CodeBehind="NDT_ReportNew.aspx.cs" Inherits="DESPLWEB.NDT_ReportNew" Theme="duro" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="stylized" class="myform" style="height: 470px;">
        <asp:Panel ID="pnlContent" runat="server" Width="100%" BorderWidth="0px" Height="470px"
                ...
                <table style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td>&nbsp;&nbsp;
                                   ...
                                   <%-- <asp:Label ID="lblReferenceBill" runat="server" Text="Reference Bill" Visible="false"></asp:Label>&nbsp;&nbsp;
                                    <asp:DropDownList ID="ddlReferenceBill" Width="140px" runat="server" Visible="false"></asp:DropDownList>--%>
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td colspan="5">
                            ...
                            &nbsp;&nbsp;&nbsp;
                                    ...
                                    <asp:RadioButton ID="optShapoorji" Text="Shapoorji" GroupName="g1" runat="server" />&nbsp;<br />
            ...
            <asp:Panel ID="Mainpan" runat="server" ScrollBars="Auto" Height="160px" Width="942px"
            ...
            <asp:Panel ID="Panel1" runat="server" ScrollBars="Auto" Height="100px" Width="942px"
                BorderStyle="Ridge" BorderColor="AliceBlue">
                                ...
                                <td colspan="2">
                                    ...
                                    <div id="divPulseVel" runat="server" visible="false">
                                        <fieldset style="border-color: #008080; width: 91%; height: 200px;">
                                            ...
                                            <asp:Panel ID="pnlIndirect" runat="server" ScrollBars="Auto" Height="100px" Width="200px"
                                                BorderStyle="Ridge" BorderColor="AliceBlue">
                                                <table width="100%">
                                                    <tr>
                                                        <td colspan="1">
                                                    ...
                                                    <tr>
                                                        <td>150</td>
                                                        <td>
                                                            <asp:Label ID="lbl150" runat="server" Text=""></asp:Label></td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="1">300</td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td colspan="1">450</td>
                                                        <td>
                                                            <asp:Label ID="lbl450" runat="server" Text=""></asp:Label></td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="1">550</td>
                                                        <td>
                                                            <asp:Label ID="lbl550" runat="server" Text=""></asp:Label></td>
                                                    </tr>
                                                </table>
                                            </asp:Panel>
                                        </fieldset>
