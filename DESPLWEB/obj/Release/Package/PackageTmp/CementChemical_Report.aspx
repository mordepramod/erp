<%@ Page Language="C#" Title="Cement Chemical Report " AutoEventWireup="true" MasterPageFile="~/MstPg_Veena.Master"
    CodeBehind="CementChemical_Report.aspx.cs" Inherits="DESPLWEB.CementChemical_Report"
    Theme="duro" %>
        ...
        <asp:Panel ID="pnlContent" runat="server" Width="100%" BorderWidth="0px" Height="470px"
                ...
                <table style="width: 100%">
                    ...
                    <tr style="background-color: #ECF5FF;">
                        ...
                        <td width="35%" align="center">
                            <asp:DropDownList ID="ddl_Grade" Width="205px" runat="server" AutoPostBack="true"
            ...
            <asp:Panel ID="Mainpan" runat="server" ScrollBars="Auto" Height="160px" BorderStyle="Ridge"
                ...
                <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="grdCCHEntryRptInward" runat="server" SkinID="gridviewSkin">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Result(%)" HeaderStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txt_result" BorderWidth="0px" Style="text-align: right" onchange="javascript:CheckValue(this);"
                                            CssClass='<%#DataBinder.Eval(Container.DataItem, "CCHTEST_TEST_Id")%>' runat="server"
                                            Width="100px" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Specified Limits(IS -1489)" HeaderStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
            ...
            <asp:Panel ID="Panel1" runat="server" ScrollBars="Auto" BorderColor="AliceBlue" BorderStyle="Ridge"
                ...
                <asp:GridView ID="grdCCHRemark" runat="server" SkinID="gridviewSkin">
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
