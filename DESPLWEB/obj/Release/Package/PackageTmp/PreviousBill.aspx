<%@ Page Title="Create New Previous Bills" Language="C#" MasterPageFile="~/MstPg_Veena.Master" AutoEventWireup="true" CodeBehind="PreviousBill.aspx.cs" Inherits="DESPLWEB.PreviousBill" %>
                ...
                <ContentTemplate>
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtWorkOrderNo" Width="120px" runat="server"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                    ...
                    <div>
                        <asp:Panel ID="pnlBillDetail" runat="server" Height="180px" ScrollBars="Auto" Width="99%"
                    ...
                    <table width="100%">
                        ...
                        <tr>
                            <td colspan="5" style="text-align: right">
                                <asp:Label ID="lblSwachhBharatTax" runat="server" Text="Swachh Bharat Tax " />
