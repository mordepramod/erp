<%@ Page Language="C#" MasterPageFile="~/MstPg_Veena.Master" AutoEventWireup="true"
    CodeBehind="CementChemical_Inward.aspx.cs" Inherits="DESPLWEB.CementChemical_Inward"
    Title="Cement Chemical Inward" Theme="duro" %>
                    ...
                    <td colspan="3" valign="top">
                        <asp:Panel ID="Mainpan" runat="server" ScrollBars="Auto" Height="180px" Width="940px">
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                <ContentTemplate>
                                    <asp:GridView ID="grdCementChemicalInward" runat="server" SkinID="gridviewSkin" OnRowDataBound="grdCementChemicalInward_RowDataBound">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Cement Name" HeaderStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtCementName" runat="server" Text='' BorderWidth="0px" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
