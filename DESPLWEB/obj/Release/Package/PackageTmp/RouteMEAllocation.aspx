<%@ Page Title="Route - ME Allocation" Language="C#" MasterPageFile="~/MstPg_Veena.Master" AutoEventWireup="true" CodeBehind="RouteMEAllocation.aspx.cs" Inherits="DESPLWEB.RouteMEAllocation" Theme="duro" %>
                            ...
                            <asp:GridView ID="grdRoute" runat="server" AutoGenerateColumns="False" OnRowCreated="grdRoute_RowCreated"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="ME">
                                        <ItemTemplate>
                                            <asp:DropDownList ID="ddl_ME" Width="240px" runat="server">
                                            </asp:DropDownList>
                                            <asp:Label ID="lblMEId" Text='<%#Eval("ROUTE_ME_Id") %>' runat="server" Visible="false"/>
                                        </ItemTemplate>
                                        <ItemStyle Width="30%" />
                                    </asp:TemplateField>
                                </Columns>
