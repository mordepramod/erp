<%@ Page Title="Cash Payment" Language="C#" MasterPageFile="~/MstPg_Veena.Master" AutoEventWireup="true" CodeBehind="VendorCashPayment.aspx.cs" Inherits="DESPLWEB.VendorCashPayment" Theme="duro" %>
    ...
    <div id="stylized" class="myform">
        <asp:Panel ID="pnlContent" runat="server" Width="100%" BorderWidth="0px" Height="470px"
            ...
            <table style="width: 100%">
                <tr>
                    <td width="12%">
                        <asp:Label ID="lblCashPaymentId" runat="server" Text="" Visible="false"></asp:Label>
                ...
                <tr>
                    <td>
                        <asp:Label ID="Label1" runat="server" Text="Payment Status"></asp:Label>
                    </td>
                    <td>
                        <asp:RadioButton ID="optCash" runat="server" Text="Cash" GroupName="g1" OnCheckedChanged="optBankVoucherType_CheckedChanged" AutoPostBack="true"/> &nbsp;&nbsp;&nbsp;
                        <asp:RadioButton ID="optBankVoucherType" runat="server" Text="Bank Voucher Type" GroupName="g1" OnCheckedChanged="optBankVoucherType_CheckedChanged" AutoPostBack="true"/>
                    </td>
                    <td>
                        ...
                        <asp:Panel ID="pnlDetailGrid" runat="server" Height="300px" Width="920px" BorderWidth="1px" ScrollBars="Auto">
                            <asp:GridView ID="grdDetails" SkinID="gridviewSkin1" runat="server" AutoGenerateColumns="False" BackColor="#F7F6F3"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="Invoice No." ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtInvoiceNo" BorderWidth="0px" Width="150px" Style="text-align: center"
                                                runat="server" Text=''  />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="Invoice Amount" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtInvoiceAmt" runat="server" Width="150px" Text=''
                                    ...
                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="Balance Amount"
                                        ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtBalanceAmt" Style="text-align: right" runat="server" BorderWidth="0px"
                                                Width="150px" ReadOnly="true" Text='' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Debit Amount" HeaderStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtDebitAmount" runat="server" EnableViewState="False" MaxLength="250"
                                                Width="100px" onkeypress="return checkDecimal(event,this);"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Credit Amount" HeaderStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtCreditAmount" runat="server" EnableViewState="False" MaxLength="250"
                                                Width="100px" onkeypress="return checkDecimal(event,this);"></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>   
                                </Columns>
