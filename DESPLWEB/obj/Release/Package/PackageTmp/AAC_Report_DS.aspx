<%@ Page Title="AAC Density Test" Language="C#" MasterPageFile="~/MstPg_Veena.Master" AutoEventWireup="true"
    CodeBehind="AAC_Report_DS.aspx.cs" Inherits="DESPLWEB.AAC_Report_DS" Theme="duro" %>
            ...
            <asp:Panel ID="Mainpan" runat="server" ScrollBars="Auto" Height="150px" Width="942px"
                ...
                <asp:GridView ID="grdAAC" runat="server" SkinID="gridviewSkin">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="Weight"
                            ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <asp:TextBox ID="txt_Weight" runat="server" BorderWidth="0px"
                                    CssClass="textbox" MaxLength="12" onchange="javascript:CheckWeight(this);"
                                    Text="" Width="100px" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="Volume">
                            <ItemTemplate>
                                <asp:TextBox ID="txt_Volume" runat="server" BorderWidth="0px"
                                    CssClass="caltextbox" ReadOnly="true"
                                    Width="100px" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="Density">
                            <ItemTemplate>
                                <asp:TextBox ID="txt_Density" runat="server" BorderWidth="0px"
                                    CssClass="caltextbox" ReadOnly="true" Width="100px"></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="Avg. Density">
                            <ItemTemplate>
                                <asp:TextBox ID="txt_AvgDensity" runat="server" BorderWidth="0px"
