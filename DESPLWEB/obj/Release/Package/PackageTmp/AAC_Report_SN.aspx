<%@ Page Title="AAC Shinkage Test" Language="C#" MasterPageFile="~/MstPg_Veena.Master"
    AutoEventWireup="true" CodeBehind="AAC_Report_SN.aspx.cs" Inherits="DESPLWEB.AAC_Report_SN"
    Theme="duro" %>
    ...
    <div id="stylized" class="myform" style="height: 480px;">
        <asp:Panel ID="pnlContent" runat="server" Width="100%" BorderWidth="0px" Height="480px"
                    ...
                    <tr>
                        ...
                        <td width="22%">
                            ...
                            <asp:CalendarExtender ID="CalendarExtender1" runat="server" CssClass="orange" Enabled="True"
                                FirstDayOfWeek="Sunday" Format="dd/MM/yyyy" TargetControlID="txt_CollectionDt">
                            </asp:CalendarExtender>
                            <asp:MaskedEditExtender ID="MaskedEditExtender1" runat="server" AutoComplete="false"
                                Mask="99/99/9999" MaskType="Date" TargetControlID="txt_CollectionDt">
                            </asp:MaskedEditExtender>
                        </td>
                        <td style="text-align: right">
            ...
            <table width="100%">
                <tr height="30px">
                    <td width="14%">
                        <asp:Label ID="Label2" runat="server" Text="Gauge Length (mm)"></asp:Label>
                    </td>
                    <td width="22%">
                        <asp:TextBox ID="txtGaugeLength" Width="200px" runat="server" Visible="true" MaxLength="12" onchange="javascript:checkNum(this);"></asp:TextBox>
                    </td>
                    <td width="20%" style="text-align: right">
                        <asp:Label ID="Label3" runat="server" Text="Least Count of dial gauge(mm)"></asp:Label>
                    </td>
                    <td>
                        <asp:TextBox ID="txtLeastCount" Width="200px" runat="server" Visible="true" MaxLength="12" onchange="javascript:CheckWeight(this);"></asp:TextBox>
                    </td>
                </tr>
                <%--<tr>
                    <td colspan="4">
                ...
                <asp:GridView ID="grdAAC" runat="server" SkinID="gridviewSkin">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="ID Mark">
                            <ItemTemplate>
                                <asp:TextBox ID="txt_IdMark" runat="server" BorderWidth="0px" Text="" Width="130px" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="Initial Wet Measurement"
                            ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <asp:TextBox ID="txt_IniWetMesurement" runat="server" BorderWidth="0px" CssClass="textbox"
                                    MaxLength="12" onchange="javascript:checkNum(this);" Text="" Width="90%" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="Final Dry Measurement">
                            <ItemTemplate>
                                <asp:TextBox ID="txt_FinalDryMesurement" runat="server" BorderWidth="0px" CssClass="textbox"
                                    MaxLength="12" onchange="javascript:checkNum(this);" Text="" Width="90%" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="Wet Measurement">
                            <ItemTemplate>
                                <asp:TextBox ID="txt_WetMeasurement" runat="server" BorderWidth="0px" CssClass="caltextbox"
                                    ReadOnly="true" Width="100px"></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="Dry Measurement"
                            ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <asp:TextBox ID="txt_DryMeasurement" runat="server" BorderWidth="0px" ReadOnly="true"
                                    CssClass="caltextbox" Text="" Width="100px" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="Dry Shrinkage">
                            <ItemTemplate>
                                <asp:TextBox ID="txt_DryShrinkage" runat="server" BorderWidth="0px" CssClass="caltextbox"
                                    ReadOnly="true" Width="100px" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="Avg. Dry Shrinkage">
                            <ItemTemplate>
                                <asp:TextBox ID="txt_AvgStr" runat="server" BorderWidth="0px" CssClass="caltextbox"
                                    ReadOnly="true" Text="" Width="100px" />
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
