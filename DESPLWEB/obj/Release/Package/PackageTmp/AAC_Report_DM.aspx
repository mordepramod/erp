<%@ Page Title="AAC Dimension Test" Language="C#" MasterPageFile="~/MstPg_Veena.Master" AutoEventWireup="true"
    CodeBehind="AAC_Report_DM.aspx.cs" Inherits="DESPLWEB.AAC_Report_DM" Theme="duro" %>
                ...
                <table style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td align="left">
                            ...
                            <asp:TextBox ID="txt_TestId" runat="server" Visible="false" Width="70px"></asp:TextBox>
                            &nbsp;&nbsp;    
                ...
                <asp:GridView ID="grdAAC" runat="server" SkinID="gridviewSkin">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="L4">
                            <ItemTemplate>
                                <asp:TextBox ID="txtL4" runat="server" BorderWidth="0" CssClass="ac" onkeyup="checkDecimal(this);"
                                    Width="40px"></asp:TextBox>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Center" />
                            <HeaderStyle HorizontalAlign="Center" />
                        ...
                        <asp:TemplateField HeaderText="Length">
                            <ItemTemplate>
                                <%--<asp:TextBox ID="txt_Length" runat="server" BorderWidth="0px" 
                                    CssClass="textbox" MaxLength="12" onchange="javascript:checkDec(this);" Text=""
                                    Width="99%" />--%>
                                <asp:TextBox ID="txt_Length" runat="server" BorderWidth="0px" CssClass="ac" ReadOnly="true" Text="" Width="40px" />
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Center" />
                            <HeaderStyle HorizontalAlign="Center" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="B1">
                            <ItemTemplate>
                                <asp:TextBox ID="txtB1" runat="server" BorderWidth="0" CssClass="ac" onkeyup="checkDecimal(this);"
                                    Width="40px"></asp:TextBox>
                            </ItemTemplate>
                            <HeaderStyle HorizontalAlign="Center" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="B2">
                            <ItemTemplate>
                                <asp:TextBox ID="txtB2" runat="server" BorderWidth="0" CssClass="ac" onkeyup="checkDecimal(this);"
                                    Width="40px"></asp:TextBox>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Center" />
                            <HeaderStyle HorizontalAlign="Center" />
                        ...
                        <asp:TemplateField HeaderText="B3">
                            <ItemTemplate>
                                <asp:TextBox ID="txtB3" runat="server" BorderWidth="0" CssClass="ac" onkeyup="checkDecimal(this);"
                                    Width="40px"></asp:TextBox>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Center" />
                            <HeaderStyle HorizontalAlign="Center" />
                        ...
                        <asp:TemplateField HeaderText="B4">
                            <ItemTemplate>
                                <asp:TextBox ID="txtB4" runat="server" BorderWidth="0" CssClass="ac" onkeyup="checkDecimal(this);"
                                    Width="40px"></asp:TextBox>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Center" />
                            <HeaderStyle HorizontalAlign="Center" />
                        ...
                        <asp:TemplateField HeaderText="B5">
                            <ItemTemplate>
                                <asp:TextBox ID="txtB5" runat="server" BorderWidth="0" CssClass="ac" onkeyup="checkDecimal(this);"
                                    Width="40px"></asp:TextBox>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Center" />
                            <HeaderStyle HorizontalAlign="Center" />
                        ...
                        <asp:TemplateField HeaderText="B6">
                            <ItemTemplate>
                                <asp:TextBox ID="txtB6" runat="server" BorderWidth="0" CssClass="ac" onkeyup="checkDecimal(this);"
                                    Width="40px"></asp:TextBox>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Center" />
                            <HeaderStyle HorizontalAlign="Center" />
                        ...
                        <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="Breadth">
                            <ItemTemplate>
                                <asp:TextBox ID="txt_Breadth" runat="server" BorderWidth="0px" CssClass="ac" ReadOnly="true" Text="" Width="40px" />
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="H1">
                            <ItemTemplate>
                                <asp:TextBox ID="txtH1" runat="server" BorderWidth="0" CssClass="ac" onkeyup="checkDecimal(this);"
                                    Width="40px"></asp:TextBox>
                            </ItemTemplate>
                            <HeaderStyle HorizontalAlign="Center" />
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="H2">
                            <ItemTemplate>
                                <asp:TextBox ID="txtH2" runat="server" BorderWidth="0" CssClass="ac" onkeyup="checkDecimal(this);"
                                    Width="40px"></asp:TextBox>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Center" />
                            <HeaderStyle HorizontalAlign="Center" />
                        ...
                        <asp:TemplateField HeaderText="H3">
                            <ItemTemplate>
                                <asp:TextBox ID="txtH3" runat="server" BorderWidth="0" CssClass="ac" onkeyup="checkDecimal(this);"
                                    Width="40px"></asp:TextBox>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Center" />
                            <HeaderStyle HorizontalAlign="Center" />
                        ...
                        <asp:TemplateField HeaderText="H4">
                            <ItemTemplate>
                                <asp:TextBox ID="txtH4" runat="server" BorderWidth="0" CssClass="ac" onkeyup="checkDecimal(this);"
                                    Width="40px"></asp:TextBox>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Center" />
                            <HeaderStyle HorizontalAlign="Center" />
                        ...
                        <asp:TemplateField HeaderText="H5">
                            <ItemTemplate>
                                <asp:TextBox ID="txtH5" runat="server" BorderWidth="0" CssClass="ac" onkeyup="checkDecimal(this);"
                                    Width="40px"></asp:TextBox>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Center" />
                            <HeaderStyle HorizontalAlign="Center" />
                        ...
                        <asp:TemplateField HeaderText="H6">
                            <ItemTemplate>
                                <asp:TextBox ID="txtH6" runat="server" BorderWidth="0" CssClass="ac" onkeyup="checkDecimal(this);"
                                    Width="40px"></asp:TextBox>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Center" />
                            <HeaderStyle HorizontalAlign="Center" />
                        ...
                        <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="Height">
                            <ItemTemplate>
                                <asp:TextBox ID="txt_Height" runat="server" BorderWidth="0px" CssClass="ac" ReadOnly="true" Text="" Width="40px" />
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
                ...
                <tr height="30px">
                    ...
                    <td align="right">
                        <asp:LinkButton ID="lnkCalculate" Font-Size="Small" runat="server" OnClick="lnkCalculate_Click"
                            Font-Bold="True" Font-Underline="true">Calculate</asp:LinkButton>&nbsp;
