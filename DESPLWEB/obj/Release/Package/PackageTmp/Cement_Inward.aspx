<%@ Page Language="C#" MasterPageFile="~/MstPg_Veena.Master" AutoEventWireup="true"
    CodeBehind="Cement_Inward.aspx.cs" Inherits="DESPLWEB.Cement_Inward" Title="Cement Inward"
    Theme="duro" %>
                ...
                <td colspan="4" valign="top">
                    <asp:Panel ID="Mainpan" runat="server" ScrollBars="Auto" Height="180px" Width="940px">
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            <ContentTemplate>
                                <asp:GridView ID="grdCementInward" runat="server" SkinID="gridviewSkin" AutoGenerateColumns="false"
                                    OnRowDataBound="grdCementInward_RowDataBound">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Cement Name" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtCementName" runat="server" Text='' Width="145px" BorderWidth="0px" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Description" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtDescription" runat="server" Width="150px" BorderWidth="0px"></asp:TextBox>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Supplier Name" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <%--<asp:TextBox ID="txtSupplierName" runat="server" Width="150px" BorderWidth="0px"></asp:TextBox>--%>
                                        ...
                                        <asp:TemplateField HeaderText="Test Details" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtTestDetails" runat="server" ReadOnly="true" Width="300px" BorderWidth="0px" />
