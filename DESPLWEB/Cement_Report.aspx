<%@ Page Language="C#" Title="Cement Test Report" AutoEventWireup="true" MasterPageFile="~/MstPg_Veena.Master"
    CodeBehind="Cement_Report.aspx.cs" Inherits="DESPLWEB.Cement_Report" Theme="duro" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <asp:Panel ID="pnlContent" runat="server" Width="100%" BorderWidth="0px" Height="470px"
            ...
            <asp:Panel ID="Panel2" runat="server" BorderStyle="Ridge" Width="942px" BorderColor="AliceBlue">
                <table style="width: 100%">
                    ...
                    <tr style="background-color: #ECF5FF;">
                        ...
                        <td width="31%" align="center">
                            <asp:DropDownList ID="ddl_Grade" Width="205px" runat="server">
                                <asp:ListItem Text="---Select---"></asp:ListItem>
                                <asp:ListItem Text="OPC 33"></asp:ListItem>
                                <asp:ListItem Text="PSC 33"></asp:ListItem>
                                <asp:ListItem Text="PPC"></asp:ListItem>
                                <asp:ListItem Text="OPC 43"></asp:ListItem>
                                <asp:ListItem Text="OPC 53"></asp:ListItem>
                            </asp:DropDownList>
                        </td>
                    ...
                    <tr style="background-color: #ECF5FF;">
                        ...
                        <td align="center" colspan="2">
                            ...
                            <asp:DropDownList ID="ddl_NABLLocation" runat="server" Width="50px" Enabled="true">
            ...
            <asp:Panel ID="Mainpan" runat="server" ScrollBars="Auto" Height="200px" BorderStyle="Ridge"
                ...
                <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="grdCementEntryRptInward" OnRowDataBound="grdCementEntryRptInward_RowDataBound"
            ...
            <asp:Panel ID="Panel1" runat="server" ScrollBars="Auto" BorderColor="AliceBlue" BorderStyle="Ridge"
                ...
                <asp:UpdatePanel runat="server" ID="UpdatePanel1">
                    <ContentTemplate>
                        <asp:GridView ID="grdCementRemark" runat="server" SkinID="gridviewSkin">
                            <Columns>
                                <asp:TemplateField>
                                    <ItemTemplate>
            ...
            <table width="100%">
                <tr height="30px">
                    ...
                    <td align="right">
                        ...
                        <asp:LinkButton ID="LnkExit" OnClick="lnk_Exit_Click" Font-Bold="True" Style="text-decoration: underline;"
    ...
    <script type="text/javascript">
        ...
        function ShowModalPopup(Output) {

            $find("ModalPopupBehaviorID").show();

            var grdCementEntryRptInward = document.getElementById('<%= this.grdCementEntryRptInward.ClientID %>');
            for (var rowId = 1; rowId < grdCementEntryRptInward.rows.length; rowId++) {

                var Result = grdCementEntryRptInward.rows[rowId].cells[0].children[0];
                var Density = "Density";
                var SoundnessByAutoClave = "Soundness  By AutoClave";
                if (Result.value.match(Density)) {


                    document.getElementById('<%= lbl_IR.ClientID %>').style.visibility = 'hidden';
                    document.getElementById('<%= txt_IR.ClientID %>').style.visibility = 'hidden';
                    document.getElementById('<%= lbl_FR.ClientID %>').style.visibility = 'hidden';
                    document.getElementById('<%= txt_FR.ClientID %>').style.visibility = 'hidden';

                }

                else if (Result.value.match(SoundnessByAutoClave)) {



                    document.getElementById('<%= lbl_Weight.ClientID %>').style.visibility = 'hidden';
                    document.getElementById('<%= txt_Weight.ClientID %>').style.visibility = 'hidden';
                    document.getElementById('<%= lbl_Volume.ClientID %>').style.visibility = 'hidden';
                    document.getElementById('<%= txt_Volume.ClientID %>').style.visibility = 'hidden';
    ...
    <script type="text/javascript">
        ...
        function SelectDetails(spanChk) {
            var grdCementEntryRptInward = document.getElementById('<%= this.grdCementEntryRptInward.ClientID %>');
            for (var rowId = 1; rowId < grdCementEntryRptInward.rows.length; rowId++) {
                var Result = grdCementEntryRptInward.rows[rowId].cells[1].children[0];
                if (Result == "Density") {
                    var txtboxvalue = document.getElementById(TextBox1).value;

                    document.getElementById(txtboxvalue).style.visibility = 'visible';
